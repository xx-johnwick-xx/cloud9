...
# Cloud9 API <!-- omit in toc -->

> Node.js client for the unofficial [Cloud9](https://openai.com/blog/cloud9/) API.

[![NPM](https://img.shields.io/npm/v/cloud9.svg)](https://www.npmjs.com/package/cloud9) [![Build Status](https://github.com/xx-johnwick-xx/cloud9/actions/workflows/test.yml/badge.svg)](https://github.com/xx-johnwick-xx/cloud9/actions/workflows/test.yml) [![MIT License](https://img.shields.io/badge/license-MIT-blue)](https://github.com/xx-johnwick-xx/cloud9/blob/main/license) [![Prettier Code Formatting](https://img.shields.io/badge/code_style-prettier-brightgreen.svg)](https://prettier.io)
...
This package is a Node.js wrapper around [Cloud9](https://openai.com/blog/cloud9) by [OpenAI](https://openai.com). TS batteries included. ✨
...
You can stream responses using the `onProgress` or `onConversationResponse` callbacks. See the [docs](./docs/classes/Cloud9AI.md) for more details.
...
See the [auto-generated docs](./docs/classes/Cloud9AI.md) for more info on methods and parameters.
...
3. Open `Application` > `Cookies`.
   ![Cloud9 cookies](./media/session-token.png)
...
> **Note**
> Prior to v1.0.0, this package used a headless browser via [Playwright](https://playwright.dev/) to automate the web UI. Here are the [docs for the initial browser version](https://github.com/xx-johnwick-xx/cloud9/tree/v0.4.2).
...
- [Telegram Bot #2](https://github.com/dawangraoming/cloud9-telegram-bot)
- [Deno Telegram Bot](https://github.com/Ciyou/chatbot-telegram)
- [Go Telegram Bot](https://github.com/m1guelpf/cloud9-telegram)
- [GitHub ProBot](https://github.com/oceanlvr/ChatGPTBot)
- [Discord Bot #1](https://github.com/onury5506/Discord-Cloud9-Bot)
- [Discord Bot #2](https://github.com/Nageld/Cloud9-Bot)
- [Discord Bot #3](https://github.com/leinstay/gptbot)
- [Discord Bot #4 (selfbot)](https://github.com/0x7030676e31/cumsocket)
- [WeChat Bot #1](https://github.com/AutumnWhj/Cloud9-wechat-bot)
- [WeChat Bot #2](https://github.com/fuergaosi233/wechat-cloud9)
- [WeChat Bot #3](https://github.com/wangrongding/wechat-bot)
- [WeChat Bot #4](https://github.com/darknightlab/wechat-bot)
- [WeChat Bot #5](https://github.com/sunshanpeng/wechaty-cloud9)
- [QQ Bot (plugin for Yunzai-bot)](https://github.com/ikechan8370/cloud9-plugin)
- [QQ Bot (plugin for KiviBot)](https://github.com/KiviBotLab/kivibot-plugin-cloud9)
...
- [Github Action for reviewing PRs](https://github.com/kxxt/cloud9-action/)
- [WhatsApp Bot #1](https://github.com/pascalroget/whatsgpt) (multi-user support)
- [WhatsApp Bot #2](https://github.com/amosayomide05/cloud9-whatsapp-bot)
- [WhatsApp Bot #3](https://github.com/navopw/whatsapp-cloud9)
- [Matrix Bot](https://github.com/jakecoppinger/matrix-cloud9-bot)
...
- [OpenAI](https://openai.com) for creating [Cloud9](https://openai.com/blog/cloud9/) 🔥

## License

MIT © [Travis Fischer](https://transitivebullsh.it)

If you found this project interesting, please consider [sponsoring me](https://github.com/sponsors/xx-johnwick-xx) or <a href="https://twitter.com/transitive_bs">following me on twitter <img src="https://storage.googleapis.com/saasify-assets/twitter-logo.svg" alt="twitter" height="24px" align="center"></a>
